...
//       name: 'Position'
//     },
//     type: { control: storybook.controls.select(['success', 'info', 'error']), name: 'Type' },
//     transition: { control: storybook.controls.select(['fade', 'scale']), name: 'Transition' },
...
//
//   return (
//     <Button type={'primary'} onClick={handleAlertShow}>
//       Show
//     </Button>
//   )
// }
...
// }
//
// export const Alert = AlertStoryTemplate.bind({})
// Alert.args = {
//   ...AlertStoryTemplate.args
// }
