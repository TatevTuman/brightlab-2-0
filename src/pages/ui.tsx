    ...
    <section>
      <Container>
        ...
        <p>
          ...
          at enim in ultricies. Vestibulum id malesuada massa, vel rutrum purus. Praesent dictum nibh at massa rhoncus,
          et aliquam est accumsan. Vestibulum volutpat magna vitae ipsum blandit, congue pretium metus pharetra. Morbi
          pharetra ex quam, ac convallis sem dapibus dictum.
        </p>
        <ul>
          <li>
            <p className="white" style={{ background: 'var(--black)', padding: '1rem' }}>
              Donec efficitur purus velit, eu vehicula dolor posuere in. Aliquam erat volutpat. Nullam mattis neque
              lacus, nec tristique urna porta congue. Maecenas eu placerat tellus. Nunc sodales, magna eu porttitor
              suscipit, massa massa finibus augue, at sodales ante sem vitae enim. Vestibulum aliquet, dui at rhoncus
              condimentum, purus lorem euismod magna, id imperdiet tellus ante at leo. Donec nec neque sit amet urna
              auctor tempus eu at neque. Pellentesque sed tempor dui.
            </p>
          </li>
          <li>
        ...
        <p className="blue">
          ...
          nec tristique urna porta congue. Maecenas eu placerat tellus. Nunc sodales, magna eu porttitor suscipit, massa
          massa finibus augue, at sodales ante sem vitae enim. Vestibulum aliquet, dui at rhoncus condimentum, purus
          lorem euismod magna, id imperdiet tellus ante at leo. Donec nec neque sit amet urna auctor tempus eu at neque.
        ...
        <ul>
          <li>
            <p className="text-xl">
              ...
              massa rhoncus, et aliquam est accumsan. Vestibulum volutpat magna vitae ipsum blandit, congue pretium
              metus pharetra. Morbi pharetra ex quam, ac convallis sem dapibus dictum.
            </p>
          </li>
          <li>
            <p className="text-lg">
