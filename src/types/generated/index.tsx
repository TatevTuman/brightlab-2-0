...
export type BookFieldsFragment = { __typename?: 'Book' } & Pick<Book, 'id' | 'title' | 'author'>

export type UserFieldsFragment = { __typename?: 'User' } & Pick<User, 'id' | 'firstName' | 'lastName' | 'email'> & {
    books?: Maybe<Array<Maybe<{ __typename?: 'Book' } & BookFieldsFragment>>>
...
export type FetchUserQuery = { __typename?: 'Query' } & { user?: Maybe<{ __typename?: 'User' } & UserFieldsFragment> }

export type FetchCurrentUserQueryVariables = Exact<{ [key: string]: never }>

export type FetchCurrentUserQuery = { __typename?: 'Query' } & {
...
export function useFetchCurrentUserQuery(
  baseOptions?: Apollo.QueryHookOptions<FetchCurrentUserQuery, FetchCurrentUserQueryVariables>
) {
...
export function useFetchCurrentUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FetchCurrentUserQuery, FetchCurrentUserQueryVariables>
) {
  return Apollo.useLazyQuery<FetchCurrentUserQuery, FetchCurrentUserQueryVariables>(
